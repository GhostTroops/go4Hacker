        ...
        <a-row :gutter="48">
          <a-col :md="4" :sm="12">
              <a-form-item :label="$t('User')">
                <a-select v-model="queryParam.user" @focus="getAllUserList">
                  <a-select-option v-for="userName in userList" :key="userName" :value="userName">{{userName}}</a-select-option>
                </a-select>
              </a-form-item>
            </a-col>
          <a-col :md="8" :sm="24">
          ...
          <template v-if="advanced">
            ...
            <a-col :md="8" :sm="24">
                <a-form-item :label="$t('StartTime')">
                  <a-date-picker v-model="queryParam.startTime" show-time style="width: 100%" :placeholder="$t('date')" />
                </a-form-item>
              </a-col>
              <a-col :md="8" :sm="24">
                <a-form-item :label="$t('EndTime')">
                  <a-date-picker v-model="queryParam.endTime" show-time style="width: 100%" :placeholder="$t('date')" />
                </a-form-item>
              </a-col>
          </template>
...
import { getHttpList, deleteHttpList, getUserNameList } from '@/api/allrecord'
