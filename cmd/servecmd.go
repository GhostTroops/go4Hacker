...
openssl req -new -x509 -sha256 -key server.key -out server.pem -days 3650`
	f.StringVar(&p.domain, "domain", "51pwn.com", "set domain, required")
	...
	f.StringVar(&p.dsn, "dsn", "file:db/godnslog.db?cache=shared&mode=rwc&_journal_mode=WAL&Synchronous=Off&temp_store=memory&mmap_size=30000000000", "set database source name,default:sqlite3, option")
